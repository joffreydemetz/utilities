...
{  
  ...
  public static function cleanCopyPasteContent(string $content)
  {
    // $content = strip_tags($content, '<p><strong><em><ul><li><a><b><i><u><ol>');
  ...
  public static function string($val)
  {
    ...
    return $val; //htmlspecialchars($val, ENT_QUOTES);
  }
